...
interface ILayerSwitcherOptions extends olx.control.ControlOptions {
    tipLabel: string;
}
...
class LayerSwitcher extends Control {
    ...
    private setLayerVisible(lyr: ol.layer.Base, visible: boolean): void {
    ...
    private ensureTopVisibleBaseLayerShown(): void {
        ...
        this.forEachRecursive(this.getMap(), (l: ol.layer.Base, idx: number, a: any) => {
